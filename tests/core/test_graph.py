...
def test_get_alias_actions():
    ...
    assert len(graph.get_actions_by_alias("tag1")) == 2
    assert len(graph.get_actions_by_alias("tag2")) == 1
    assert len(graph.get_actions_by_alias("tag3")) == 1
